...
def test_future_rewards_modules_and_tables_are_not_registered_before_later_rewards_items() -> None:
    metadata = bootstrap.get_target_metadata()
    reward_tables = {
...
def test_alembic_history_includes_reward_foundation_revision() -> None:
